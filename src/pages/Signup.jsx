...
function Signup() {
    ...
    async function uploadImage() {
        ...
        data.append("upload_preset", "ea5drzhq");
        try {
            setUploadingImg(true);
            let res = await fetch("https://api.cloudinary.com/v1_1/ddjlrks71/image/upload", {
                method: "post",
                body: data,
            })
        ...
        <Container>
            <Row>
                ...
                <div className="signup-profile-pic__container">
                           ...
                           <> <FontAwesomeIcon icon={faPlusCircle} className="add-picture-icon" /></>
                            </label>
